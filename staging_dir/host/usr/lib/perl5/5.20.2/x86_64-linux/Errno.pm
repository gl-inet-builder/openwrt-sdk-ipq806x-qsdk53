...
"x86_64-linux-4.4.0-137-generic" or
	die "Errno architecture (x86_64-linux-4.4.0-137-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
