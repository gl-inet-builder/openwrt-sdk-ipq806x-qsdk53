...
#define __GMP_CC "arm-openwrt-linux-uclibcgnueabi-gcc -std=gnu99"
#define __GMP_CFLAGS "-Os -pipe -march=armv7-a -mtune=cortex-a7 -fno-caller-saves -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -mfloat-abi=soft -fpic "
