...
#endif
	OL_ATH_PARAM_CHANSWITCH_OPTIONS = 326,  /* It is used to set the channel switch options */
	OL_ATH_BTCOEX_ENABLE        = 327,
	OL_ATH_BTCOEX_WL_PRIORITY   = 328,
	OL_ATH_PARAM_TID_OVERRIDE_QUEUE_MAPPING = 329,
	OL_ATH_PARAM_CAL_VER_CHECK = 330,
	OL_ATH_PARAM_NO_VLAN = 331,
	OL_ATH_PARAM_CCA_THRESHOLD = 332,
	OL_ATH_PARAM_ATF_LOGGING = 333,
	OL_ATH_PARAM_STRICT_DOTH = 334,
	OL_ATH_PARAM_DISCONNECTION_TIMEOUT = 335,
	OL_ATH_PARAM_RECONFIGURATION_TIMEOUT = 336,
	OL_ATH_PARAM_CHANNEL_SWITCH_COUNT = 337,
	OL_ATH_PARAM_ALWAYS_PRIMARY = 338,
	OL_ATH_PARAM_FAST_LANE = 339,
	OL_ATH_GET_BTCOEX_DUTY_CYCLE = 340,
	OL_ATH_PARAM_SECONDARY_OFFSET_IE = 341,
	OL_ATH_PARAM_WIDE_BAND_SUB_ELEMENT = 342,
	OL_ATH_PARAM_PREFERRED_UPLINK = 343,
	OL_ATH_PARAM_PRECAC_ENABLE = 344,
	OL_ATH_PARAM_PRECAC_TIMEOUT = 345,
	OL_ATH_COEX_VER_CFG = 346,
	OL_ATH_PARAM_TXCHAINSOFT = 347,
	OL_ATH_PARAM_SMARTLOG_ENABLE = 348,
	OL_ATH_PARAM_SMARTLOG_FATAL_EVENT = 349,
	OL_ATH_PARAM_AMSDU_ENABLE = 350,
	OL_ATH_PARAM_ACS_RANK = 351,
	OL_ATH_PARAM_DUMP_TARGET = 352,
#if OL_ATH_CE_DEBUG
	OL_ATH_PARAM_CE_DESC_DBG_EN = 353,
#endif /* OL_ATH_CE_DEBUG */
#if OL_ATH_SMART_LOGGING
	OL_ATH_PARAM_SMARTLOG_SKB_SZ = 354,
#endif /* OL_ATH_SMART_LOGGING */
	OL_ATH_PARAM_TWICE_ANTENNA_GAIN = 355,
	OL_ATH_PARAM_BEST_UL_HYST = 356,
	OL_ATH_PARAM_TXACKTIMEOUT = 357,
	/*
	 * control rx batching in FW;
	 *  bits 0-15 for time interval in which indications will be counted
	 *  bits 16-31 for count of rx_indication after which batching to start
	 */
	OL_ATH_PARAM_RX_MITIGATION  = 358,
	OL_ATH_PARAM_DYN_AUTO_BURST = 359,
#if QCN_ESP_IE
	OL_ATH_PARAM_ESP_PERIODICITY = 360,
	OL_ATH_PARAM_ESP_AIRTIME = 361,
	OL_ATH_PARAM_ESP_PPDU_DURATION = 362,
#endif
	OL_ATH_PARAM_MAX_CLIENTS_PER_RADIO = 363,
	OL_ATH_PARAM_CHAN_AP_RX_UTIL = 365,
